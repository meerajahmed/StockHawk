...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmptyView = findViewById(R.id.empty_recycler_view);
                    ...
                    new MaterialDialog.Builder(mContext).title(R.string.symbol_search)
                            ...
                            .input(R.string.input_hint, R.string.input_prefill, new MaterialDialog.InputCallback() {
                                ...
                                public void onInput(MaterialDialog dialog, CharSequence input) {
                                    ...
                                    if (c.getCount() != 0) {
                                        Toast toast =
                                                Toast.makeText(MyStocksActivity.this, R.string.symbol_exists,
                                                        Toast.LENGTH_LONG);
                                        ...
                                        if (!symbol.isEmpty()) {
                                            ...
                                            Toast.makeText(MyStocksActivity.this, R.string.enter_symbol,
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (mCursorAdapter.getItemCount() == 0) {
            message = Utils.isNetworkAvailable(mContext) ? R.string.network_toast : R.string.stock_widget_empty;
            ((TextView) mEmptyView).setText(message);
